...
/**
 * <p>Classe Java de GiftCardException complex type.
 * 
 * <p>O seguinte fragmento do esquema especifica o conteúdo esperado contido dentro desta classe.
 * 
 * <pre>
 * &lt;complexType name="GiftCardException">
 *   &lt;complexContent>
...
@XmlType(name = "GiftCardException", propOrder = {
    "message"
})
public class GiftCardException
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof GiftCardException)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final GiftCardException that = ((GiftCardException) object);
        {
            String lhsMessage;
